				...
				<div class="dk_events_calendar">
					<?php
						...
						<?php while ( $events->have_posts() ) : $events->the_post();
							$eventmeta = get_post_meta( $post->ID, 'music_event', true );
							$eventDate = date_create($eventmeta['event-date']);
						?>
							<li class="dk_event">
								<?php if(isset($eventmeta['event-image']) && $eventmeta['event-image']) { ?>
								...
								<div class="dk_body">
									...
									<?php if(isset($eventmeta['event-website']) && $eventmeta['event-website']) { ?>
										<a class="dk_artist_website" href="<?php echo $eventmeta['event-website']; ?>">Aritst Website</a>
									<?php } ?>
									<?php if(isset($eventmeta['event-facebook']) && $eventmeta['event-facebook']) { ?>
										<a class="dk_artist_facebook" href="<?php echo $eventmeta['event-facebook']; ?>" title="Artist Facebook Link"><i class="fa fa-facebook" aria-hidden="true"></i></a>
									<?php } ?>
								</div>
							</li>
						<?php endwhile; ?>
